...
### Long Description
```
Tired of habit apps that demand too much?

Ssak is different.

🌱 Just 3 Habits
You can't add unlimited habits. That's by design. Plant only what truly matters.
...
• 축하 화면이 브랜드와 맞춰졌어요
  컨페티 대신 자라나는 싹으로 인사해요

• 위젯이 더 정돈됐어요
  정렬과 여백을 다듬었습니다

작은 한 탭이 어디까지 자라는지 지켜봐주세요.
```

**릴리즈 설정**
- 출시 방식: 승인 후 자동 출시
- 대응 피드백: FB-002, FB-003, FB-004 (모두 v1.2 싹 성장 시스템으로 통합 해결)
...
• 알람 설정을 온보딩에 추가
  습관을 등록한 직후 바로 알람을 설정할 수 있어요.
  시간은 습관에 맞게 자동으로 제안돼요.

• 습관 프리셋 단순화
  분량과 횟수는 여러분이 직접 정하세요.
  "물 2L" 대신 "물 마시기"처럼 단순하게 바꿨습니다.
